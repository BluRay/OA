...
<div id="content" class="ui-content fn-clear" coor="default" coor-rate="0.02">
	<div class="ui-grid-21" coor="content">
		<div class="ui-grid-21 ui-grid-right record-tit" coor="title">
			<h2 class="ui-tit-page">日记信息列表</h2>
			
			<div class="record-tit-amount">
				<p>总共有<span class="number"><?php echo public_number('blog')?></span>条数据
              </p>
			</div>
		</div>
...
<a href="admin.php?ac=<?php echo $ac?>&fileurl=<?php echo $fileurl?>" class="ui-tab-trigger-text">我的日记</a></li>	
<li class="ui-tab-trigger-item<?php echo $_check['ischeck1']?>">
<a href="admin.php?ac=<?php echo $ac?>&fileurl=<?php echo $fileurl?>&type=1" class="ui-tab-trigger-text">他人的日记</a></li>					
</ul>
				</div>
...
<div class="fn-right">
<?php echo get_exceldown('excel_5')?></div>
</div>
...
<td class="info"><?php
						if($row['type']=='1'){
						echo "<span style='color:#006600;'>隐藏</span>";
						}else{
						echo "公开";
						}
						?></td>
